...
public class AndroidTreeView extends RecyclerView {
    ...
    private class TreeViewAdapter extends RecyclerView.Adapter<RViewHolder> {
        ...
        public void onBindViewHolder(RViewHolder holder, int position) {
            ...
            final RelativeLayout rlRoot = (RelativeLayout) holder.getConvertView().findViewById(R.id.rl_tree_node);
            final CheckBox checkBox = (CheckBox) holder.getConvertView().findViewById(R.id.checkbox);
            final ImageView iconLevel = holder.getImageView(R.id.iv_icon_right);
            final MarqueeTextView textView = (MarqueeTextView) holder.getConvertView().findViewById(R.id.tv_text);
            ...
            //添加层级内边距
            rlRoot.setPadding((int) (mLevelPadding * node.getLevel()), 0, 0, 0);
