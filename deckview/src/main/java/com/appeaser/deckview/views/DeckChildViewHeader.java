...
public class DeckChildViewHeader extends FrameLayout {
    ...
    public DeckChildViewHeader(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLightDismissDrawable = res.getDrawable(R.drawable.deck_child_view_dismiss_light, null);
        mDarkDismissDrawable = res.getDrawable(R.drawable.deck_child_view_dismiss_dark, null);
