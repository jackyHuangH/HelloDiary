package cn.hzjdemo.hellodiary.widgets.viewpager;
...
//            mAdapter.registerDataSetObserver(mObserver);
    ...
    void populate() {
        ...
        // Add and remove pages in the existing content_bottomsheet_dialog.
        int lastPos = -1;
        for (int i = 0; i < mItems.size(); i++) {
        ...
        if (DEBUG) {
            Log.i(TAG, "Current page content_bottomsheet_dialog:");
            for (int i = 0; i < mItems.size(); i++) {
