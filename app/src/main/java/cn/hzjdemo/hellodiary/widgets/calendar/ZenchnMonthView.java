package cn.hzjdemo.hellodiary.widgets.calendar;
 ...
 * date  :2018/1/25/025
 * desc  ：农房日历月视图
 * record：TODO 问题大大的，canvas不熟悉
 */

public class ZenchnMonthView extends MonthView {
    ...
    public ZenchnMonthView(Context context) {
        super(context);
    }
    ...
    protected void onPreviewHook() {
        ...
        mSchemeCircleRTPadding = dipToPx(getContext(), 4);
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
        ...
        canvas.drawCircle(x + mItemWidth - mSchemeCircleRTPadding - mSchemeRTRadio / 2, y + mSchemeCircleRTPadding + mSchemeRTRadio, mSchemeRTRadio, mSchemeRTPaint);
        canvas.drawText(calendar.getScheme(), x + mItemWidth - mSchemeCircleRTPadding - mSchemeRTRadio, y + mSchemeRTRadio + mSchemeRTBaseLine, mTextPaint);

        //下面的圆点标记
        canvas.drawCircle(x + mItemWidth / 2, y + mItemHeight - mSchemeBottomPadding, mSchemeBottomRadio, mSchemeBottomPaint);
    }
